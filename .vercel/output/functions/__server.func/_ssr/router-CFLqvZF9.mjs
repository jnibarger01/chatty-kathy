...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CFLqvZF9.js
var router_CFLqvZF9_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-Brmky4sF.css";
var APP_NAME = "Relay";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Real-time rooms over persistent FastAPI WebSockets."
			},
			{
				name: "theme-color",
				content: "#0c0c0b"
...
var $$splitComponentImporter = () => import("./routes-D0H5faKo.mjs");
...
//#endregion
export { getRouter, router_CFLqvZF9_exports as t };
